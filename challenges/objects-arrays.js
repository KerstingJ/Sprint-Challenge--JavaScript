...
let trex = {name: "tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceious"};

let spike = {name: "stegosaurus", diet: "herbivorous", weight: "2000kg", length: "9m", period: "Late Jurassic"};

let blue = {name: "velociraptor", diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceious"};

let dinos = [trex, spike, blue];
dinos.forEach(dino => dino.roar = () => `RAWERSRARARWERSARARARRRR!`);
